...
test('fixture contains traceable operational domains and no client records', () => {
  for (const token of ['metrics','orders','inventory','income','expenses','catalog','exceptions','handoffs','fixture.orders','fixture.inventory_snapshot','fixture.catalog_registry']) assert.match(js, new RegExp(token.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')));
